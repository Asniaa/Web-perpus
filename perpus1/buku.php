...
<head>
  ...
  <style>
    ...
    .card-img-top {
      ...
      background-color: #f8f9fa; /* supaya latar gambar netral saat ada ruang kosong */
    }
    .card:hover {
...
<body>
  ...
  <div class="container mb-5">
    ...
    <div class="d-flex justify-content-between mb-3">
      <a href="tambahbuku.php" class="btn btn-dark">➕ Tambah Buku</a>
    </div>
          ...
          <div class="col">
            <div class="card h-100 shadow-sm">
              ...
              <div class="card-footer bg-white border-0 d-flex justify-content-between">
                <a href="ubahbuku.php?id=<?= $buku['id']; ?>" class="btn btn-info btn-sm">✏️ Ubah</a>
                <a href="hapusbuku.php?id=<?= $buku['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus buku ini?')">🗑️ Hapus</a>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
